          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow(
                ...
                "Thailand, Bangkok, Baiyok tower (location data)",
              ),
              const SizedBox(height: 8),
              _buildInfoRow(
                Icons.calendar_month_outlined,
                "Sat, 25 Oct 2025 | 18:00 - 22:00 (time data)",
              ),
    ...
    return SizedBox(
      ...
      child: Stack(
        children: List.generate(4, (index) {
          if (index == 3) {
            // แสดง "+10" เมื่อเกิน 3 คน อาจปรับให้แสดงจำนวนจริงจากข้อมูลได้
            return Positioned(
              left: index * 20,
              child: CircleAvatar(
                radius: 15,
